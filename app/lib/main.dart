...
class _FundusAppState extends State<FundusApp> {
  ...
  Future<void> _openCatalogWork(FundusCatalogEntry entry) async {
    ...
    await showFundusRemoteServers(
      ...
      initialWork: FundusRemoteWork(
        id: entry.work.id,
        title: entry.work.title,
        authors: entry.work.authors.isEmpty
            ? [entry.work.author]
            : entry.work.authors,
        hasCover:
            entry.work.coverPath != null || entry.work.coverVersion != null,
        kind: entry.work.kind,
        subtitle: entry.work.subtitle,
        series: entry.work.series,
        seriesSequence: entry.work.seriesSequence,
        coverVersion: entry.work.coverVersion,
        narrators: entry.work.narrators,
        language: entry.work.language,
        description: entry.work.description,
        publisher: entry.work.publisher,
        publishedYear: entry.work.publishedYear,
        fileCount: entry.work.fileCount,
        progressPosition: entry.work.progressPosition,
        progressDuration: entry.work.progressDuration,
        progressTrackIndex: entry.work.progressTrackIndex,
        progressFinished: entry.work.progressFinished,
        contentSensitivity: entry.work.contentSensitivity,
        contentStyle: entry.work.contentStyle,
        tags: entry.work.tags,
        lastListenedAt: entry.work.lastListenedAt,
        providerMetadata: entry.work.providerMetadata,
      ),
