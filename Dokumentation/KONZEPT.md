...
5. **Mobile end-to-end** — Handy per QR koppeln, Hörbuch laden, Flugmodus, 10 Minuten hören, wieder verbinden. Fortschritt steht auf dem Desktop. Danach umgekehrt
   - **Hintergrundwiedergabe** — während lokaler, gestreamter und offline heruntergeladener Wiedergabe den Bildschirm sperren und Fundus in den Hintergrund schicken. Titel, Hörbuch, Autor, Dauer und Cover (sofern lokal verfügbar) erscheinen in der Android-Medienanzeige; Play/Pause, 10 Sekunden zurück, 30 Sekunden vor, vorherige/nächste Datei und die Zeitleiste steuern denselben Fundus-Player
...
10. **Sleep-Timer mobil** — umgesetzt: feste und freie Dauer, Ziel-Uhrzeit, Trackende sowie bei lokalen Chapterdaten Kapitelende; Schütteln ist gerätespezifisch aktivierbar, startet die gewählte Dauer neu und bestätigt per Einblendung sowie optional haptisch. Nach dem regulären Ablauf bleiben zwei Minuten, um durch Schütteln dieselbe Dauer erneut zu starten und die pausierte Wiedergabe fortzusetzen. Empfindlichkeit und Cooldown sind einstellbar, Bewegungen innerhalb des Cooldowns verlängern nicht erneut
    - Netzwerk- und Offline-Wiedergabe erhalten dieselben Chaptertitel, Dateiindizes, Start- und Dauerdaten wie der Desktop-Player; Chapter können angesprungen und als Sleep-Timer-Ziel verwendet werden, ohne Serverpfade an den Client zu übertragen
